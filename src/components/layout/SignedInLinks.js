...
const SignedInLinks = (props) => {
  return (
    <ul className="right">
      ...
      <li><a onClick={props.signOut}><i class="material-icons">power_settings_new</i></a></li>
      <li><NavLink to='/' className='btn btn-floating green accent-3'>{props.profile.iniciais}</NavLink></li>
    </ul>
  )
}
